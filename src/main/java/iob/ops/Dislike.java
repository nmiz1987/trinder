...
@Component("Dislike")
public class Dislike implements CommandInvoker {
	private InstanceServiceJpa instanceServiceJpa;
	private UsersServiceJpa usersServiceJpa;

	@Autowired
	public Dislike(InstanceServiceJpa instanceServiceJpa, UsersServiceJpa usersServiceJpa) {
		super();
	...
	public Object invokeCommand(ActivityBoundary command) {
		String likeAttributeKey = "dislike";
